! computer code for flowoverobstacle
module variables
    ...
    Real(8) :: uo=0.20d0, sumvelo=0d0, rhoo=5d0, alpha=0.02d0, sum=0d0, usum=0d0, vsum=0d0
    Real(8) :: Re, omega, t1, t2, rhow, rhoav, rhom
end module variables

program flowoverobstacle
    use variables
    implicit none
    m= 40; n= 500
...
subroutine sfbound
    ...
    ! Obstacles at the inlet x = 40 , y = 20
    do i = 0,40
        f(2,i,20) = f(4,i,20)
        f(5,i,20) = f(7,i,20)
        f(6,i,20) = f(8,i,20)
