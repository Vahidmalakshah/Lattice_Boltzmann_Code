...
module variables
    ...
    Real(8), Dimension(:,:), Allocatable :: u, v, rho, phi, phi1 , gphix, gphiy, nx, ny 
...
program Droplet
    ...
    allocate(u(0:n,0:m),v(0:n,0:m),rho(0:n,0:m))
...
Subroutine Initial
    ...
    Do i=0,n
			Do j=0,m
                ...
                z = sqrt((i-50)**2d0 + (j-50)**2d0) - 30d0
				phi(i,j) = 0.5d0 -  0.5d0*tanh(2d0*z/zed)
